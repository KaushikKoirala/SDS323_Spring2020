...
qplot(wine_scores[,1], wine_scores[,2], color=color, facets=~quality,xlab='Component 1', ylab='Component 2', data = wine)
...
# faceting by color and look at quality trends, doesn't work well
qplot(wine_scores[,1], wine_scores[,2], color=quality, facets=~color,xlab='Component 1', ylab='Component 2', data = wine)

qplot(wine_scores[,1], wine_scores[,3], color=quality, facets=~color,xlab='Component 1', ylab='Component 3', data = wine)

qplot(wine_scores[,2], wine_scores[,3], color=quality, facets=~color,xlab='Component 2', ylab='Component 3', data = wine)
...
# see that there seems to be separation bewteen higher and lower quality, but not clear with our PCA
